<x-dynamic-component :component="$getFieldWrapperView()" :field="$field">
    ...
    <div ax-load ax-load-src="{{ \Filament\Support\Facades\FilamentAsset::getAlpineComponentSrc('map-component', package: 'postare/gis-tools') }}" x-load-css="[@js(\Filament\Support\Facades\FilamentAsset::getStyleHref('gis-tools-styles', package: 'postare/gis-tools'))]" x-data="mapComponent({
        ...
        locate: {{ $locate }},
        geoJson: {{ $geoJson }},
    })" x-ignore wire:ignore class="relative">
        ...
        @if (!$getDisableMarker())
            ...
            <button x-show="marker" class="absolute bottom-0 left-0 z-50 m-4 flex h-8 w-8 items-center justify-center rounded-full border-red-800 bg-red-500 px-2 py-1 opacity-70 hover:opacity-100" type="button" @click="removeMarker()"
